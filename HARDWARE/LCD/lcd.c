...
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode, u16 back_color, u16 color)
{  							  
    u8 temp,t1,t;
	u16 y0=y;
	u16 BACK_COLOR;
...
//size:字体大小
//*p:字符串起始地址		  
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p, u16 back_color, u16 color)
{         
	u8 x0=x;
	u16 BACK_COLOR;
	u16 POINT_COLOR;
    ...
    {       
        ...
        LCD_ShowChar(x,y,*p,size,0,BACK_COLOR,POINT_COLOR);
        x+=size/2;
        p++;
    }  
}
...
void LCD_ShowlongNum(u16 x,u16 y,u32 num,u8 len,u8 size,u16 back_color, u16 color)
{
	...
	LCD_ShowxNum(x,y,num,len-3*loc,size,128,back_color,color);
}
